...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mainContent">
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <asp:Button ID="btnPhone" runat="server" Text="Phone" Width="60px" Height="45px"
                            CssClass="btnButton" />
                        <asp:Button ID="btnName" runat="server" Text="Name" Width="60px" Height="45px" CssClass="btnButton" />
                        <asp:Button ID="btnID" runat="server" Text="ID" Width="60px" Height="45px" CssClass="btnButton" />
                        <asp:Button ID="btnInvoice" runat="server" Text="Invoice" Width="60px" Height="45px"
                            CssClass="btnButton" />
                    </td>
                </tr>
            </table>
        ...
        <div id="RightSide">
            ...
            <asp:Panel ID="Panel2" runat="server" GroupingText="DROP LIST" Width="478px" Height="268px">
                <table>
                    <tr>
                        <td>
